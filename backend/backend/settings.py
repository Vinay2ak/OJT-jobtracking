...
# dj_database_url imported at the top of the file
...
# Django 4.2+ uses STORAGES instead of deprecated STATICFILES_STORAGE
STORAGES = {
    "default": {
...
# timedelta imported at the top of the file
